...
function ShowClean()
{
	...
	$('#PhonyBody').append('<h6 class="card-subtitle mb-2 fm" id="PhonyItemClean">clean</h6>');
...
{
	var ItemIns = '<h6 class="card-subtitle mb-2 fm" id="PhonyItem'+String(PhonyId)+'">'+document.getElementById("target"+String(PhonyId)).value+'</h6>';
